...
const ADMIN_NAV = [
  ...
  { key: 'revenue', name: '📈 Financial Revenue Audit', href: '/revenue', icon: Activity },
  { key: 'access', name: '🔑 "Who Has Access" Report', href: '/access', icon: User },
  { key: 'payments', name: '💳 Razorpay Payments & Fees', href: '/payments', icon: Settings },
  { key: 'users', name: 'Users & Admins', href: '/users', icon: Users },
  { key: 'admins', name: '👑 Admin RBAC Control', href: '/admins', icon: Crown },
